...
## 7. Results (Phase 1: Naive Baseline)
* **Outcome:** Confirmed hypothesis.
* **Metric Deception:** Accuracy (0.96) masked poor Recall (0.38).
* **System Fragility:** Encountered numerical instability warnings (`divide by zero`) during execution, suggesting the naive pipeline is brittle on local silicon.
* **Next Action:** We must construct a "Robust Baseline" to fix the leakage and the metric.
